...
class ParameterDialog(QDialog, Ui_Dialog_Pop_Parameter):
    def __init__(self):
        ...
        # # 读取地址8开始的2个寄存器（1个参数），factory1_2_realtime_data_jcj表
        # inserter.insert_mcgs_realtime_data(
        #     table_name="factory1_2_realtime_data_jcj",
        #     start_address=8,
        #     register_count=2,
        #     field_names=["parameter3"],
        #     ip="192.168.10.30"
        # )
    ...
    def update_realtime_data(self):
        ...
        if data:  # 如果成功获取数据
            ...
            self.label_18 and self.lineEdit_24.setText(str(data['parameter3']))  # 更新数值3标签
            self.label_22 and self.lineEdit_54.setText(str(data['parameter4']))  # 更新数值4标签
            self.label_26 and self.lineEdit_57.setText(str(data['parameter5']))  # 更新数值5标签
            self.label_30 and self.lineEdit_56.setText(str(data['parameter6']))  # 更新数值6标签
            self.label_34.setText(str(data['parameter7']))  # 更新数值7标签
            self.label_38.setText(str(data['parameter8']))  # 更新数值8标签
            self.label_42 and self.label_104.setText(str(data['parameter9']))  # 更新数值9标签
            self.label_46 and self.label_105.setText(str(data['parameter10']))  # 更新数值10标签
            self.label_50.setText(str(data['parameter11']))  # 更新数值11标签
            print(data['parameter1', 'parameter2', 'parameter3', 'parameter4', 'parameter5', 'parameter6', 'parameter7', 'parameter8', 'parameter9', 'parameter10', 'parameter11'])  # 测试用，打印数据
        ...
        if data:  # 如果成功获取数据
            ...
            print(data['parameter1', 'parameter2', 'parameter3', 'parameter4'])  # 测试用，打印数据
        ...
        if data:  # 如果成功获取数据
            ...
            print(data['parameter1', 'parameter2', 'parameter3', 'parameter4', 'parameter5', 'parameter6'])  # 测试用，打印数据
        ...
        if data:  # 如果成功获取数据
            ...
            print(data['parameter1', 'parameter2', 'parameter3'])  # 测试用，打印数据
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def update_realtime_data(self):
        ...
        if data:  # 如果成功获取数据
            ...
            print(data['parameter1', 'parameter2', 'parameter3', 'parameter4', 'parameter5'])  # 测试用，打印数据
