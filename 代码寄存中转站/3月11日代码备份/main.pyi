...
#         # 1. 从字典中获取对应表名的更新策略（函数对象）,这里的update_strategies.get(table_name)的值为对应表名的value
...
#         """更新挤出机实时数据"""
#         self.label_53.setText(str(data.get('parameter1', '')))
#         self.label_57.setText(str(data.get('parameter2', '')))
#         self.label_61.setText(str(data.get('parameter3', '')))
#         self.label_65.setText(str(data.get('parameter4', '')))
#         print('放卷机实时数据：', data['parameter1'], data['parameter2'], data['parameter3'], data['parameter4'])  # 测试用，打印数据
#
#     def _update_zdj_realtime(self, data):
#         """更新挤出机实时数据"""
#         self.label_73.setText(str(data.get('parameter1', '')))
#         self.label_77.setText(str(data.get('parameter2', '')))
#         self.label_81.setText(str(data.get('parameter3', '')))
#         self.label_85.setText(str(data.get('parameter4', '')))
#         self.label_89.setText(str(data.get('parameter5', '')))
#         self.label_93.setText(str(data.get('parameter6', '')))
...
#         print('曲线1实时数据：', data['parameter1'], data['parameter2'], data['parameter3'], data['parameter4'], data['parameter5'], data['parameter6'])  # 测试用，打印数据
#
...
#         print('挤出机实时数据：', data['parameter1'], data['parameter2'], data['parameter3'], data['parameter4'], data['parameter5'])  # 测试用，打印数据
#
